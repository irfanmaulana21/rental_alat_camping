...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/pelanggan/home.css'); ?>">
...
<section class="features-section" id="features">
    <div class="section-label" data-aos="fade-up">Kenapa CampRent?</div>
...
<section class="content-section reverse" data-aos="fade-up">
    <div class="cs-image-wrap">
        <img src="<?= base_url('assets/image/bener/alat alat.jpeg'); ?>" alt="Alat Camping">
...
<section class="content-section" data-aos="fade-up">
    <div class="cs-image-wrap">
        <img src="<?= base_url('assets/image/bener/orang bahagia.jpeg'); ?>" alt="Pelanggan Bahagia">
    ...
    <div class="cs-text" data-aos="fade-left" data-aos-delay="200">
        ...
        <div class="testimonial-quote">
            <p>"CampRent beneran memudahkan persiapan hiking kami. Rekomen banget!"</p>
